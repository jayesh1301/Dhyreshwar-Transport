...
export const getAcknowledgeById = createAsyncThunk(
  "GET_ACKNOWLEDGE_DETAIL",
  async (requestObject) => {
    const { data, status } = await fetchAckDetail(requestObject);
    return { data, status };
  }
);
...
export const getAllLRAckList = createAsyncThunk(
  "GET_ALL_LR_ACK",
  async (requestObject) => {
    const { data, status } = await fetchAllLRAckList(requestObject);
    return { data, status };
  }
);
...
export const deleteLorryReceiptAck = createAsyncThunk(
  "REMOVE_LR_ACK",
  async (requestObject) => {
    
    const { data, status } = await removeLorryReceiptAck(requestObject);
    return { data, status };
  }
);
